...
if ($conn->select_db('nois') === TRUE) {
    ...
    if ($row_count > 0) {
        ...
        // open form
        echo ' <form action="confirm_reviews.php" method="post">';
      ...
      ' . $db_case_description . ' </td>';
            ...
            echo ' <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            ...
                            hover:text-white border-transparent border-collapse" id="1" title="Select a category">
                                                ...
                                                <option value="Accepted">Approve and Forward</option>
        ...
        echo '  <!-- agree -->
                ...
                <!-- Confirm -->
                <div class="mt-6">
                    <button type="submit" name="confirm_review" class="w-full bg-gray-900 hover:bg-orange-600 text-white transition-colors  font-bold py-2 px-4 rounded-md">
                        Confirm My Reviews
                    </button>
                </div>';
