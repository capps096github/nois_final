...
if ($conn->select_db('nois') === TRUE) {
    ...
    $sql = "SELECT * FROM nois.cases WHERE cases.course_code = '$course_unit' ORDER BY cases.case_no ASC";
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-900 text-gray-900">
                                ...
                                <thead class="bg-gray-900 ">
                                    <tr>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-orange-600 uppercase ">
                                         <p>     CASE </p>
                                        </th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-orange-600 uppercase ">
                                           <p>  CASE Tracking  Number </p>
                                        </th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-orange-600 uppercase ">
                                            <p> Student Number </p>
                                        </th>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-orange-600 uppercase ">
                                           <p>  DESCRIPTION </p>
                                        </th>
                                ...
                                <!-- Table Body -->
                                <tbody class="bg-gray-100 text-left divide-y divide-gray-200">
                                   ';
        // table rows
