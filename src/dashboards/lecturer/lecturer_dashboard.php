...
<head>
    ...
    <!-- title -->
    <title>NOIS | Lecturer's Dashboard</title>
...
<body class="bg-blue-200">
    <section class="flex flex-col h-screen justify-between">
        ...
        <nav class="md:flex md:justify-between lg:flex lg:justify-between md:px-4 px-2 py-5 fixed top-0 left-0 right-0 bg-gray-900">
            <!-- back -->
            <a href="../../home.php" class="duration-300 transition-colors flex md:justify-start lg:justify-start justify-center items-center space-x-2 text-white hover:text-orange-600 hover:no-underline hover:cursor-pointer">
            ...
            <a href="" class="space-x-2 flex justify-center items-center mt-4 md:mt-0" title="NOIS | Student's Dashboard">
                <div class="flex text-orange-600 font-bold hover:text-white hover:underline items-center space-x-2">
                    ...
                    <p class="">NOIS ADMIN ACCOUNT (LECTURER

                        <?php
                        echo "  -  " . $_SESSION["username"] . "  -  " . $_SESSION["lecturer_id"] .  ")";
                        ?>
            ...
            <div class="space-x-4 flex justify-center items-center mt-4 md:mt-0">
                ...
                <!-- Add Missing Marks -->
                <a href="add_missing_marks.php" class="flex items-center rounded-md  text-sm font-medium pl-2 pr-3 py-2 shadow-sm text-gray-900 hover:text-white bg-white hover:bg-orange-600 hover:no-underline normal-case px-5  transition-colors duration-300">
                ...
                <!-- Submit Results -->
                <a href="submit_results.php" class="flex items-center rounded-md text-white text-sm font-medium pl-2 pr-3 py-2 shadow-sm hover:text-gray-900 hover:bg-white hover:no-underline normal-case px-5 bg-orange-600 transition-colors duration-300">
                    <svg width="20" height="20" fill="currentColor" class="mr-2" aria-hidden="true">
                        <path d="M10 5a1 1 0 0 1 1 1v3h3a1 1 0 1 1 0 2h-3v3a1 1 0 1 1-2 0v-3H6a1 1 0 1 1 0-2h3V6a1 1 0 0 1 1-1Z" />
                    </svg>
                    Submit Results
                ...
                <!-- Log Out -->
                <a href="../../auth/logout/admin_logout.php" class="text-orange-600 hover:text-white hover:bg-red-700 rounded-md font-semibold normal-case px-5 py-2 text-sm bg-transparent transition-all duration-300">
                    <span>Log Out</span>
                </a>
        ...
        <!-- Main -->
        <main class="md:mt-20 lg:mt-20 mt-40 p-4 space-y-4 w-full mx-auto">

            <!-- cousre -->
            <div class="space-x-2 flex justify-center items-center mt-4 md:mt-0" title="NOIS | Student\'s Dashboard">
            ...
            <h2 class="text-3xl text-gray-900 tracking-tight mt-4 mb-10 text-center font-extrabold sm:text-4xl md:text-5xl mx-auto">
                The
                <span class="text-orange-600 underline xl:inline">Nois</span>
                Complaints (Cases) from your Students.
            </h2>


            <?php
            require_once 'complaints_table.php';
            ?>
