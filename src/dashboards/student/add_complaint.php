    ...
    <section class="flex flex-col h-screen justify-between">
        ...
        <main class="md:mt-20 lg:mt-20 mt-60 p-4 space-y-4 max-w-5xl mx-auto">
            <h2 class="text-3xl text-gray-900 tracking-tight mt-4 mb-10 text-center font-extrabold sm:text-4xl md:text-5xl mx-auto">
                ...
                <span class="text-orange-600 underline xl:inline">Add a Complaint</span>
                Today.
            </h2>

            <!-- form -->
            <form class="md:mt-20 lg:mt-20 mt-60 p-4 space-y-4 max-w-3xl mx-auto" method="post" action="complain.php">
                <div class="space-y-4">

                    <!-- course drop down -->
                    <label class="block mt-4">
                        <span class="block text-sm font-medium text-gray-900">Course With Complaint:</span>
                ...
                <label class="block items-center justify-center">
                    <span class="block text-sm font-medium text-gray-900">Complaint (Case) Description</span>
                    <input type="text" name="case_description" placeholder="Complaint Description. e.g. I have Missing Marks" class="text-gray-900 mt-1 w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900" required />
                </label>
                </div>
                ...
                <div class="mt-6">
                    <button type="submit" name="add_complaint" class="w-full bg-orange-600 hover:bg-orange-500 transition-colors text-white font-bold py-2 px-4 rounded-md">
                        Add Complaint
                    </button>
                </div>
            </form>
