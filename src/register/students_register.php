...
<head>
    ...
    <!-- Title -->
    <title>NOIS | Student's Sign Up</title>
    <!-- CSS -->
    ...
    <main class="mx-auto sm:max-w-4xl max-w-4xl px-4 sm:mt-5 sm:px-6 md:mt-8 lg:mt-10 lg:px-8 xl:mt-14">
        <div
            ...
            <p class="text-2xl tracking-tight font-extrabold">
                Any Result Complaints?
            </p>

            <h2 class="text-3xl tracking-tight mt-4 font-extrabold sm:text-4xl md:text-5xl mx-auto">
                Create a
                <span class="text-blue-300 hover:text-orange-600 underline xl:inline">Nois Student Account</span>
                and Get Started
            </h2>
        ...
        <div class="mt-10 justify-center items-center">
            <div class="max-w-xl mx-auto">
                <form class="space-y-6" action="../auth/register/student_register.php" method="post">
                    <!-- student number -->
                    ...
                    <!--Courses Filter  -->
                    <label class="block mt-4">
                        <span class="block text-sm font-medium text-orange-600">Courses Registered For:</span>

                        <div class="space-x-4 space-y-2 mt-2 items-center justify-center flex flex-col">
                            <!-- Course 1 -->
                            <select name="first_course" class=" text-left font-bold bg-white rounded-lg focus:rounded-md  text-gray-900
                            ...
                            <select name="second_course" class=" text-left font-bold bg-white rounded-lg focus:rounded-md  text-gray-900
                             border-transparent border-collapse" id="2" title="Select a Course">
                                <option value="none" selected>Course 2</option>
                                 <option value="CSC-113">Introduction to Computer Science XIII (CSC-113)</option>
                                <option value="CSC-114">Introduction to Computer Science XIV (CSC-114)</option>
                                <option value="CSC-115">Introduction to Computer Science XV (CSC-115)</option>
                                <option value="CSC-116">Introduction to Computer Science XVI (CSC-116)</option>
                    ...
                    <label class="block items-center justify-center">
                        ...
                        <input type="text" name="username" placeholder="Your Name e.g @cephas, @simon, @ankunda"
                               class="text-gray-900 mt-1 w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600"
                               required/>
                    </label>
                    ...
                    <label class="block mt-4">
                        ...
                        <input type="email" name="email"
                               placeholder="Your Email e.g cephas@nois.edu, andante@yahoo.com, simon@gmail.com"
                               class="text-gray-900 mt-1 w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600"
                               required/>
                    </label>
                  ...
                  <svg class="fill-current h-5 w-5" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <div class="transition-colors duration-300">
                        ...
                        <p
                            ...
                            Have an account?
                            <span onclick="goToLogin('register')"
